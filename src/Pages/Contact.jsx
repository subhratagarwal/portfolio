...
const ContactPage = () => {
  ...
  <div className="h-auto py-10 flex items-center justify-center px-[5%] md:px-0" id="Contact">
    ...
    <div
      ...
      className="
        w-full max-w-3xl
        bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-5 py-10 sm:p-10
        transform transition-all duration-300 hover:shadow-[#6366f1]/10
      "
    >
      ...
      <form
        action="https://formsubmit.co/subhratagarwal1234@gmail.com"
        method="POST"
