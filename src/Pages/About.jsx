          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              ...
              >
                ...
                <ul
                  className="text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed text-justify list-disc pl-5 space-y-2"
                  data-aos="fade-right"
                  data-aos-duration="1500"
                >
                  <li>
                    B.Tech (CSE - Data Science) student with strong skills in Java, Python, and full-stack web development.
                  </li>
                  <li>
                    Built AI-powered and full-stack projects using React.js, Node.js, MongoDB, TensorFlow, and PyTorch.
                  </li>
                  <li>
                    Completed internships in Web Development, AI, and DBMS; solved 100+ problems on LeetCode.
                  </li>
                  <li>
                    Top performer in national hackathons and active contributor in tech and cultural college clubs.
                  </li>
                  <li>
