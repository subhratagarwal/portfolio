...
const StatusBadge = memo(() => (
      <div
      className="inline-block animate-float lg:mx-0 mt-10"
      data-aos="zoom-in"
      data-aos-delay="400"
    >
...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/subhratagarwal" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/subhrat-agarwal-a19569234/" },
  { icon: Instagram, link: "https://www.instagram.com/subhratagarwal/" },
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden pt-24" id="Home">
      {/* ^^^ Added pt-24 for top padding to prevent overlap with navbar */}
      <div
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Crafting smart, functional applications that address real-world needs with innovation.
                </p>
