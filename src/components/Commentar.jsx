...
// === OWNER CREDENTIALS ===
const OWNER_EMAIL = "subhratagarwal1234@gmail.com";
const OWNER_PASSWORD = "Subhrat@1234";
...
const Komentar = () => {
    ...
    // === Only fetch and show comments if owner is logged in ===
    useEffect(() => {
        if (!isOwner) return;
    ...
    // === If not owner, show login form ===
    if (!isOwner) {
        return (
            <div className="w-full bg-gradient-to-b from-white/10 to-white/5 rounded-2xl overflow-hidden backdrop-blur-xl shadow-xl p-6">
                ...
                <form onSubmit={handleOwnerLogin} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-white py-3 rounded-xl font-semibold"
                    >
                        Login as Owner
                    </button>
                </form>
    ...
    // === If owner, show the comment section as before ===
    return (
